      ...
      <div className={styles.heroBaner}>
        <div className={styles.heroText}>
          ...
          <p className={styles.heroDiscription}>
            Календарь предстоящих событий в мире криптовалют. Следите за миром блокчейна с помощью
            нашего криптокалендаря. Здесь собраны все основные события, связанные с криптовалютой.
