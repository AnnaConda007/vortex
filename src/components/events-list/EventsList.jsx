    ...
    <>
      <section className={styles.eventsContainer}>
        <div className={`${styles.eventsRow} ${styles.eventsRow_head}`}>
          <div className={`${styles.eventsItem} ${styles.eventsItemHeader}`}>
            {' '}
            <h2 className='headerTitle'>Дата</h2>
          </div>
          <div className={`${styles.eventsItem} ${styles.eventsItemHeader}`}>
            {' '}
            <h2 className='headerTitle'>Название события</h2>{' '}
          </div>
          <div className={`${styles.eventsItem} ${styles.eventsItemHeader}`}>
            {' '}
            <h2 className='headerTitle'>Расположение</h2>
          </div>
        </div>
