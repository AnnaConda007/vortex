...
const EventListItem = ({ event }) => {
  ...
  return (
    <div className={`${eventsListStyles.eventsRow} ${eventsListStyles.eventsList}`}>
      <div className={`${eventsListStyles.eventsItem} ${styles.date}`} onClick={handleClick}>
        <EventDate start={date_start} end={date_end} />
      </div>
      <div className={`${eventsListStyles.eventsItem} ${styles.title}`} onClick={handleClick}>
        {' '}
        {title}{' '}
      </div>
      <div className={`${eventsListStyles.eventsItem} ${styles.location}`} onClick={handleClick}>
        {' '}
        {location}{' '}
      </div>
    </div>
